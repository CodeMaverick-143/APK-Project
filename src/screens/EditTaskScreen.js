...
const EditTaskScreen = ({ route, navigation }) => {
    ...
    const [deadlineDate, setDeadlineDate] = useState(task.deadlineDate ? new Date(task.deadlineDate) : new Date());
        ...
        <GlassWrapper>
            ...
            >
                <View style={[styles.header, { padding: spacing.l, borderBottomColor: colors.border }]}>
                    ...
                    <TouchableOpacity onPress={handleSave} disabled={title.length === 0}>
                        <BlurView
                            intensity={80}
                            tint={isDark ? 'dark' : 'light'}
                            style={[
